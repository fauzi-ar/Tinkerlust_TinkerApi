...
class OAuth2_Controller_TokenController implements OAuth2_Controller_TokenControllerInterface
{
    ...
    public function __construct(OAuth2_ResponseType_AccessTokenInterface $accessToken, OAuth2_Storage_ClientInterface $clientStorage, array $grantTypes = array(), OAuth2_ClientAssertionType_ClientAssertionTypeInterface $clientAssertionType = null, OAuth2_ScopeInterface $scopeUtil = null)
    {
    ...
    public function handleRevokeRequest(OAuth2_RequestInterface $request, OAuth2_ResponseInterface $response)
    {
     ...
     * @return bool|null
     */
    public function revokeToken(OAuth2_RequestInterface $request, OAuth2_ResponseInterface $response)
    {
        if (strtolower($request->server('REQUEST_METHOD')) != 'post') {
