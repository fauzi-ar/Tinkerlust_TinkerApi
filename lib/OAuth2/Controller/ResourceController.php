...
class OAuth2_Controller_ResourceController implements OAuth2_Controller_ResourceControllerInterface
{
    ...
    public function __construct(OAuth2_TokenType_TokenTypeInterface $tokenType, OAuth2_Storage_AccessTokenInterface $tokenStorage, $config = array(), OAuth2_ScopeInterface $scopeUtil = null)
    {
