 ...
 */
class OAuth2_ResponseType_JwtAccessToken extends OAuth2_ResponseType_AccessToken
{
     ...
     */
    public function __construct(OAuth2_Storage_PublicKeyInterface $publicKeyStorage = null, OAuth2_Storage_AccessTokenInterface $tokenStorage = null, OAuth2_Storage_RefreshTokenInterface $refreshStorage = null, array $config = array(), OAuth2_Encryption_EncryptionInterface $encryptionUtil = null)
    {
        ...
        if (is_null($tokenStorage)) {
            ...
            $tokenStorage = new OAuth2_Storage_Memory();
        }
        if (is_null($encryptionUtil)) {
            $encryptionUtil = new OAuth2_Encryption_Jwt();
        }
