 ...
 */
class OAuth2_GrantType_JwtBearer implements OAuth2_GrantType_GrantTypeInterface, OAuth2_ClientAssertionType_ClientAssertionTypeInterface
{
    private $jwt;
     ...
     * @param array $config
     */
    public function __construct(OAuth2_Storage_JwtBearerInterface $storage, $audience, OAuth2_Encryption_EncryptionInterface $jwtUtil = null, array $config = array())
    {
