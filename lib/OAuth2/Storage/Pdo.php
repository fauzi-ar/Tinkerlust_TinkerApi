 ...
 */
class OAuth2_Storage_Pdo implements
    ...
    OAuth2_Storage_PublicKeyInterface,
    OAuth2_OpenID_Storage_UserClaimsInterface,
    OAuth2_OpenID_Storage_AuthorizationCodeInterface
{
    protected $db;
    protected $config;
