 ...
 */
class OAuth2_OpenID_Controller_AuthorizeController extends OAuth2_Controller_AuthorizeController implements OAuth2_OpenID_Controller_AuthorizeControllerInterface
{
    private $nonce;

    protected function setNotAuthorizedResponse(OAuth2_RequestInterface $request, OAuth2_ResponseInterface $response, $redirect_uri, $user_id = null)
    {
