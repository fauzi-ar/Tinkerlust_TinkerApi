...
class OAuth2_OpenID_ResponseType_IdToken implements OAuth2_OpenID_ResponseType_IdTokenInterface
{
    ...
    public function __construct(OAuth2_OpenID_Storage_UserClaimsInterface $userClaimsStorage, OAuth2_Storage_PublicKeyInterface $publicKeyStorage, array $config = array(), OAuth2_Encryption_EncryptionInterface $encryptionUtil = null)
    {
